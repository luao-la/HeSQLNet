...
model_dir = os.path.join(top_data_dir, 'roberta-base/')
os.environ["CUDA_VISIBLE_DEVICES"] = "0,1"  # "5,6,7,8,9","0,1,2,3,4"
import os
...
version = '41a1'  ####################
model_name = 'SQLHet_v{}_{}_{}_{}'.format(version, graph_gnn_layers, text_att_layers, emb_dims)
# model_name = 'SpiderCogent_T5'
...
log_path = os.path.join(res_dir, model_name + '.txt')
